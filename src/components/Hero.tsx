    ...
    <section className="min-h-screen flex items-center justify-center relative overflow-hidden">
      ...
      >
        ...
        <div className="flex gap-4 justify-center mb-12">
          ...
          <a href="https://drive.google.com/file/d/17DdUvP2YV37FxKusTuBrx24-sv2Li6iE/view?usp=sharing" className="bg-secondary text-secondary-foreground px-6 py-3 rounded-lg hover:bg-secondary/80 transition-colors">
            View Resume
          </a>
        </div>
        ...
        <div className="flex gap-6 justify-center">
          ...
          <a href="mailto:yarrapothusaichandu@gmail.com" className="text-muted-foreground hover:text-primary transition-colors">
